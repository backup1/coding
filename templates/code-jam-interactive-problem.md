# Code Jam Interactive Problem

```bash
$ g++ A.cpp; python interactive_runner.py python local_testing_tool.py 0 -- ./a.out

$ python3 interactive_runner.py python3 local_testing_tool.py 0 -- python3 prog.py
```
